...
namespace OutGame.Infrastructure.Repositories
{
    ...
    public class UserProfileRepositoryImpl : IUserProfileRepository
    {
        ...
        public Domain.Models.UserProfile Load()
        {
            ...
            return new Domain.Models.UserProfile(userId, userName, level, gold);
        }

        public void Save(Domain.Models.UserProfile profile)
        {
